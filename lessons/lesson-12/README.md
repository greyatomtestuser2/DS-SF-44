...
6. Create a feature for the title containing "recipe". Is the % of evergreen websites higher or lower on pages that have "recipe" in the title?
...
> Open and work through the exercises in the [starter code notebook](./code/starter-code-12.ipynb).
...
> Use the iPython notebooks for [starter](./code/starter-code-12.ipynb) and [solution](./code/solution-code-12.ipynb) code in this section
