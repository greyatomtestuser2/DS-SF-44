...
> Make sure you can open [say-hi.py ](./code/say-hi.py) in a text editor of your choice.
...
> Demo'ed SSH Tunnel to a remote server
...
> Walk through [starter code](./code/starter-code-5.ipynb) with students.
