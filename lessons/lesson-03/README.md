...
> Open the [starter-code](./code/starter-code-3.ipynb). Solutions are available in [the solution-code](./code/solution-code-3.ipynb).

### Codealong Part 1: Basic Stats-
> Review "Part 1. Basic Stats" of the [starter-code](./code/starter-code-3.ipynb).
...
> Review "Part 2. Box Plot" of the [starter-code](./code/starter-code-3.ipynb).
...
![](./images/biasVsVarianceImage.png)
...
with [this notebook](./code/extra/central_limit_theorem.ipynb)

### Codealong Part 3: Standard Deviation & Variance
> Review "Part 3. SD & Variance" of the [starter-code](./code/starter-code-3.ipynb).
...
> Use the [lesson-3-demo](./code/lesson-3-demo.ipynb) for this section.
...
- Skewed? Not smooth? Transform your data (log, sqrt, etc.)
