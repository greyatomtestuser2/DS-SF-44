...
> See [solution code](./code/solution-code-8.ipynb) for more detail.
...
Using the [following starter code](./code/starter-code-8.ipynb) and the iris data set, test and evaluate the following questions:
